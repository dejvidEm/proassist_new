  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-2xl font-medium text-onBackground mb-2">Stránka sa nenašla</h2>
        <p className="text-onBackground/70 mb-8">
          Tento obsah tu nie je alebo bola adresa prepísaná. Môžete sa vrátiť späť alebo ísť na úvodný web ProAssist.
        </p>
